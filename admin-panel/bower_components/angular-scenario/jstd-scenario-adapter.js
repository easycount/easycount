 ...
 * Now, when you call <code>browser().navigateTo('index.ejs')</code> in your scenario test, the browser will open /your-prefix/index.ejs.
 * That matches the proxy, so JSTD will proxy this request to http://localhost:8000/index.ejs.
 */
